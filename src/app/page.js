        ...
        <div className="container">
          <div className="row home">
            <div className="col-lg-6 mt-3">
              ...
              <p className="fw-bold text-light h pt-4" data-aos="fade-up" data-aos-duration="3000">Where Freshness Meets Care</p>
              <p className="white-50" data-aos="fade-up" data-aos-duration="3000">
              ...
              <div className="my-3 d-flex gap-3">
                <button className="btn btn-info border-0 p-3 rounded fw-bold" data-aos="fade-up" data-aos-duration="3000">Pick Up Now</button>
                <button className=" btn btn-warning border-0 p-3 rounded fw-bold" data-aos="fade-up" data-aos-duration="3000">Discover More</button>
              </div>
            </div>
        ...
        <div className="container">
          <div className="row m-20">
            <div className="col-lg-4 m20w text-center">
              <div className="shadow s2c bg-light rounded px-4 py-3" data-aos="fade-up" data-aos-duration="3000">
    ...
    <section className=" my-2">
      <div className="container">
        <div className="row mt-4">
          <div className="col-lg-6">
            <h2 className="fw-bold text-blue mt-3 " data-aos="fade-up" data-aos-duration="3000">Schedule Your Pick-Up or Delivery, We'll Take Care of the Rest!</h2>
          ...
          <div className="col-lg-6">
            <img className="img-fluid rounded" data-aos="fade-up" src="./img/beauty.jpg" alt="image" />
          </div>
        </div>
      </div>
    </section>
      ...
      <div className="container">
        ...
        <div className="col-lg-6 mt-3" data-aos="fade-up" data-aos-duration="3000">
          ...
          <div className="col-lg-5 offset-lg-1 my-5">
            <span className="bg-blue p-2 fw-bold text-light rounded" data-aos="fade-up" data-aos-duration="3000">Quality Assurance</span>
            <h1 className="text-uppercase  fw-bold text-blue mt-4" data-aos="fade-up" data-aos-duration="3000">Your Satisfaction is our Commitment.</h1>
            <p className='text-dark' data-aos="fade-up" data-aos-duration="3000">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae, praesentium consequuntur. Praesentium </p>
            <div className="fw-bold">  
              <p data-aos="fade-up" data-aos-duration="3000"><TiTick style={{color: '#0b61f4'}}  /> Eco-conscious Cleaning</p>
              <p data-aos="fade-up" data-aos-duration="3000"><TiTick style={{color: '#0b61f4'}}  /> Specialty Fabric Care</p>
              <p data-aos="fade-up" data-aos-duration="3000"><TiTick style={{color: '#0b61f4'}}  /> Non-Toxic Stain Removal</p>
              <p data-aos="fade-up" data-aos-duration="3000"><TiTick style={{color: '#0b61f4'}}  /> Carbon-Neutral Delivery</p>
            </div>
          </div>
        </div>
      </div>
