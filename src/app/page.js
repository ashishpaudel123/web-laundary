        ...
        <div className="container">
          <div className="row home">
            <div className="col-lg-6 mt-3">
              ...
              <p className="white-50" data-aos="fade-up" >
              ...
              <div className="my-3 d-flex gap-3">
                ...
                <button className=" btn btn-warning border-0 p-3 rounded fw-bold" data-aos="fade-up" >Discover More</button>
              </div>
            </div>
        ...
        <div className="container">
          <div className="row m-20">
            <div className="col-lg-4 m20w text-center">
              <div className="shadow s2c bg-light rounded px-4 py-3" data-aos="fade-up" >
      ...
      <div className="container">
        <div className="row mt-4">
          <div className="col-lg-6">
            ...
            <div className="bg-light-blue shadow rounded" data-aos="fade-up" >
      ...
      <div className="container">
        ...
        <div className="col-lg-6 mt-3" data-aos="fade-up" >
          ...
          <div className="col-lg-5 offset-lg-1 my-5">
            <span className="bg-blue p-2 fw-bold text-light rounded" data-aos="fade-up" >Quality Assurance</span>
            <h1 className="text-uppercase  fw-bold text-blue mt-4" data-aos="fade-up" >Your Satisfaction is our Commitment.</h1>
            <p className='text-dark' data-aos="fade-up" >Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae, praesentium consequuntur. Praesentium </p>
            <div className="fw-bold">  
              <p data-aos="fade-up" ><TiTick style={{color: '#0b61f4'}}  /> Eco-conscious Cleaning</p>
              <p data-aos="fade-up" ><TiTick style={{color: '#0b61f4'}}  /> Specialty Fabric Care</p>
              <p data-aos="fade-up" ><TiTick style={{color: '#0b61f4'}}  /> Non-Toxic Stain Removal</p>
              <p data-aos="fade-up" ><TiTick style={{color: '#0b61f4'}}  /> Carbon-Neutral Delivery</p>
            </div>
          </div>
        </div>
      </div>
