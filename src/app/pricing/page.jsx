  ...
  return (
    <>
        ...
        <div className="container">
            ...
            <p className="text-uppercase text-center fw-bold text-blue" data-aos="fade-up" >What we offer</p>
            <h1 className="text-uppercase fw-bold mt-3 text-center text-blue" data-aos="fade-up" >Price Packages</h1>
            </div>
            <div className="row">
            <div className="col-lg-4 my-4">
                <div className="shadow rounded" data-aos="fade-up" >
